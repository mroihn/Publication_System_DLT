    ...
    <div className="max-w-3xl mx-auto w-full p-6">
      <div className="mb-8">
        ...
        <p className="text-slate-400 mt-2">
          Modify your previously submitted score and critique for an active review.
        </p>
      </div>

      <form onSubmit={handleSubmit} className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-xl space-y-6">
        <div>
          <label htmlFor="reviewId" className="block text-sm font-medium text-slate-300 mb-2">
            Review ID / Manuscript ID
          </label>
          <input
            type="text"
            id="reviewId"
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Provide updated constructive feedback..."
          />
        </div>
